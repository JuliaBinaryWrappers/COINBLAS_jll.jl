...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import COINBLAS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("70ea7731-f516-5e6d-b63f-53a67d65e1cf"))
platforms = [Pkg.Artifacts.unpack_platform(e, "COINBLAS", artifacts_toml) for e in artifacts["COINBLAS"]]
...
if best_platform === nothing
    @debug("Unable to load COINBLAS; unsupported platform $(triplet(platform_key_abi()))")
else
