# Autogenerated wrapper script for COINBLAS_jll for x86_64-apple-darwin14-libgfortran3
export libcoinblas
...
const libcoinblas_splitpath = ["lib", "libcoinblas.0.0.0.dylib"]
...
const libcoinblas = "@rpath/libcoinblas.0.dylib"
