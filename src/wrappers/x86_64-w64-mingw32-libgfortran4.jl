# Autogenerated wrapper script for COINBLAS_jll for x86_64-w64-mingw32-libgfortran4
export libcoinblas
...
const libcoinblas_splitpath = ["bin", "libcoinblas-0.dll"]
...
const libcoinblas = "libcoinblas-0.dll"
